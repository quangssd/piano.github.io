...
<div class="col-12 "  aria-label="breadcrumb">
	<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
		...
		<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="breadcrumb-item active">
			<span itemprop="name">Phụ kiện</span><meta itemprop="position" content="3" /></li>
	</ol>
</div>			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="product__grid item__grid row">
			...
			while ($row = mysqli_fetch_assoc($query_phukien)){
				?>	

		<div class="col-xl-20th col-lg-20th col-md-4 col-sm-6 col-6">
		<form action="phukien.php" method="post">	
